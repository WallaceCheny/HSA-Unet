...
class FocusedLinearAttention(nn.Module):
    r""" Window based multi-head self attention (W-MSA) module with relative position bias.   dim (int): Number of input channels.
...
class DualTransformerBlock(nn.Module):
    ...
    def __init__(self, in_dim, key_dim, value_dim, head_count=1, token_mlp="mix"):
        ...
        self.attn = FocusedLinearAttention(dim=self.in_dim, window_size=(1, 1), num_heads=head_count)
